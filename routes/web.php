...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('settings/units/{unit}/edit', [UnitController::class, 'edit'])->name('settings.units.edit');
    ...
    Route::patch('para-clinic-requests/{paraClinicRequest}/payment', [ParaClinicRequestController::class, 'payment'])->name('para-clinic-requests.payment');
