...
- For tabular pages that should match the Patients feature, prefer the Patients-style MUI X `DataGrid` pattern over the reusable `DataTable` component. Confidence: 0.92
