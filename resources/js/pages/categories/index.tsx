                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="border-b border-gray-200 bg-gray-50/80">
                                ...
                                <th className="px-6 py-3.5 text-xs font-semibold uppercase tracking-wider text-gray-500 text-end">
                                    Actions
                                </th>
                            </tr>
                        </thead>
                        ...
                        categories.data.map((cat) => (
                            ...
                            >
                                ...
                                <td className="px-6 py-3.5 flex items-center justify-end">
                                    <IconButton onClick={() => handleEdit(cat)} aria-label={`Edit ${cat.name}`}>
                                        <Pencil size={16} />
                                    </IconButton>
                                    <IconButton color='error' onClick={() => handleDelete(cat.id, cat.name)} aria-label={`Delete ${cat.name}`}>
                                        <Trash2 size={16} />
                                    </IconButton>
                                </td>
                            </tr>
