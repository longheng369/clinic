  ...
  if (!billing) {
    return (
      <Box sx={{ textAlign: 'center', py: 6 }}>
        ...
        <Box sx={{ fontSize: 18, fontWeight: 600, color: '#475569', mb: 1 }}>No billing data</Box>
        <Box sx={{ color: '#94a3b8', fontSize: 14 }}>Select an active visit to view billing information.</Box>
      </Box>
    )
  }
  ...
  return (
    <Box>
      ...
      <Paper variant="outlined" sx={{ p: 3, mb: 3, borderRadius: 2 }}>
        <Typography sx={{ fontSize: 13, fontWeight: 600, color: '#475569', mb: 2, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
               Charge Breakdown
        </Typography>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1.5, borderBottom: '1px solid #f1f5f9' }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
              ...
              <Typography sx={{ fontSize: 14, color: '#475569' }}>Consultation Fees</Typography>
            </Box>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1.5, borderBottom: '1px solid #f1f5f9' }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
              ...
              <Typography sx={{ fontSize: 14, color: '#475569' }}>Medication Costs</Typography>
            </Box>
            <Typography sx={{ fontSize: 14, fontWeight: 600, color: '#1e293b' }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1.5 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
              ...
              <Typography sx={{ fontSize: 14, color: '#475569' }}>Paraclinic Costs</Typography>
            </Box>
            <Typography sx={{ fontSize: 14, fontWeight: 600, color: '#1e293b' }}>
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 3, mb: 3 }}>
        <Paper variant="outlined" sx={{ p: 3, borderRadius: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}>
            ...
            <Typography sx={{ fontSize: 13, fontWeight: 600, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                     Totals
            </Typography>
          </Box>
        ...
        <Paper variant="outlined" sx={{ p: 3, borderRadius: 2 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', pt: 1.5, borderTop: '2px solid #e2e8f0' }}>
              <Typography sx={{ fontSize: 14, fontWeight: 600, color: '#1e293b' }}>Balance</Typography>
              <Typography sx={{
                fontSize: 16,
                fontWeight: 700,
            ...
            {billing.payment_date && (
              <Typography sx={{ fontSize: 12, color: '#94a3b8', mt: 1 }}>
                        Last payment: {new Date(billing.payment_date).toLocaleDateString('en-US', { month: 'short', day: '2-digit', year: 'numeric' })}
              </Typography>
            )}
          </Box>
        </Paper>
