  ...
  useEffect(() => {
    reset({
      ...
      respiratory_system_symptoms:
        consultation.respiratory_system_symptoms ?? [],
      respiratory_system_others_note:
        consultation.respiratory_system_others_note ?? '',
      ...
      musculoskeletal_others_note:
        consultation.musculoskeletal_others_note ?? '',
      ...
      renal_reproductive_symptoms:
        consultation.renal_reproductive_symptoms ?? [],
      renal_reproductive_others_note:
        consultation.renal_reproductive_others_note ?? '',
    ...
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        <Button
          ...
          onClick={() =>
            router.visit(
              `/patients/${patient.id}/consultations/${consultation.id}/edit`,
            )
          }
        >
          Edit
